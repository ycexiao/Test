...
# -*- coding: utf-8 -*-
#
# my-package documentation build configuration file, created by
...
try:
    fullversion = version("my_package")
except Exception:
...
# abbreviations
ab_authors = "Sangjoon Lee, Simon Billinge"
...
modindex_common_prefix = ["my-package"]
...
basename = "my-package".replace(" ", "").replace(".", "")
